...
<h4 class="container bg-dark text-left text-light ">Sección B</h4>
</div>
 <!----------------------------------------------------------------------------> 
...
<button type="button" class="btn btn-primary"   id="open_damage_section_shipment"><i class="fa-solid fa-circle-plus"></i></button>
</div>
</div>
