...
<div class="card container col-12 row m-0 d-flex justify-content-center mt-2 mb-2">
<div class="container col-12 row d-flex justify-content-center">
<div class="card container col-lg-11 bg-dark mt-2 m-0 mb-2">
<h4 class="container bg-dark text-left mb-0 text-light ">Sección C</h4>
</div>

<div class="col-1 mt-2 mb-2" role="group" aria-label="Basic mixed styles example">
<button type="button" class="btn btn-danger" id="closet_missing_section_shipment"><i class="fa-solid fa-circle-minus"></i></button>
<button type="button" class="btn btn-success"   id="open_missing_section_shipment"><i class="fa-solid fa-circle-plus"></i></button>
</div>
</div>
<br>
