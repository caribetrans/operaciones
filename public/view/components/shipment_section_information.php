...
<div class="container col-12 row m-0 d-flex justify-content-center">
 <!----------------------------------------------------------------------------> 
<div class="card container col-lg-11 bg-dark mt-2 m-0 mb-2">
<h4 class="container bg-dark text-left text-light ">Sección A</h4>
</div>
 <!----------------------------------------------------------------------------> 
...
<button type="button" class="btn btn-success"   id="open_section_information"><i class="fa-solid fa-circle-plus"></i></button>
</div>
</div>
 <!----------------------------------------------------------------------------> 
<br>
...
<div class="mb-3 col-lg-2">
  <label for="exampleFormControlInput1" class="form-label">Peso según AWB</label>
  <input type="text" class="form-control" required id="weight_awb" name="weight_awb" placeholder="Peso según AWB">
</div>

<div class="mb-3 col-lg-2">
  <label for="exampleFormControlInput1" class="form-label">No. Piezas según AWB</label>
...
<div class="mb-3 col-lg-2">
  ...
  <select class="form-select" required id="irregularity_type" name="irregularity_type" aria-label="Default select example" title="Seleccione" placeholder="Seleccione" oninvalid="this.setCustomValidity('Por favor, completar este campo')" oninput="setCustomValidity('')">
